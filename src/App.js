...
class App extends Component {
  ...
  render() {
    ...
    return (
      <div className="App" >
        <Link target="_blank" variant="body2" href="https://github.com/Dev-CasperTheGhost/bmi-converter" >Source Code</Link>
        <form  style={{marginTop: "20px"}} onSubmit={this.getBmi}>
